...
const MindNode: React.FC<NodeProps<NodeData>> = ({ id, data, selected }) => {
  ...
  return (
    <div
      className={
        `rounded bg-black shadow px-4 py-3 text-sm border ${selected ? 'border-blue-500 ring-2 ring-blue-400' : 'border-gray-200'
        }`
      }
    ...
    >
      ...
      <div
        className="drag-handle cursor-grab select-none -mx-4 -mt-3 mb-3 px-5 py-3 bg-gray-900 border-b border-gray-800 rounded-t text-gray-200 text-sm flex items-center gap-2"
